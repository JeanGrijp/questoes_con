...
**O que mudou?** Algumas construções ganharam maior tolerância no uso culto brasileiro, especialmente na fala e em registros semi-formais. Contudo, em concursos e na redação oficial, mantém-se o padrão tradicional.

- Ex.: A próclise em início de oração com verbo auxiliar tem ampla aceitação: “Não vou te contar” (uso corrente no PB). Em textos muito formais, ainda se pode preferir “Não te vou contar”, mas a primeira forma já é largamente aceita.

**Importante (norma para prova e redação oficial)**: após preposição + infinitivo com sujeito expresso, use o pronome reto: “para eu fazer”, “sem eu perceber”, “antes de eu chegar”. A forma “para mim fazer” permanece coloquial e deve ser evitada em textos formais.

**Por que isso acontece?** A pressão do uso popular, especialmente quando vem de falantes escolarizados, força reavaliações. Mas a flexibilização não é aleatória: em provas, siga a gramática normativa e os manuais de redação oficial.
...
1. **Correção de inadequações**: Corrigir trechos que apresentam marcas de oralidade inadequadas ao texto escrito formal.

1. **Vocabulário**: Substituir termos coloquiais por equivalentes cultos.
